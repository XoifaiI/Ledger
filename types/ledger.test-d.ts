...
function FrozenReducer(this: void, state: Ledger.Frozen<Bag>, op: Ledger.Op<BagOps>): Ledger.Frozen<Bag> | undefined {
	if (op.Amount > state.Gold) {
		return undefined;
	}
	return { ...state, Gold: state.Gold - op.Amount };
}
